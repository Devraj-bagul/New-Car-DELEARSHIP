  ...
  return (
    <div className="relative w-full h-[55vh] min-h-[300px] max-h-[500px] mb-4 sm:h-[100vh] sm:min-h-[700px] sm:max-h-none sm:mb-0 bg-[#0a0a0a] overflow-hidden flex flex-col justify-center items-center rounded-b-[20px] sm:rounded-b-0 shadow-2xl">
      ...
      <div className="absolute inset-0 w-full h-full z-0">
        ...
        {/* Cinematic Premium Overlay - Enhanced for readability */}
        <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/20 to-black/80 z-10 pointer-events-none" />
        <div className="absolute inset-0 bg-black/30 z-10 pointer-events-none sm:bg-black/20" />
      </div>
      ...
      <div className="relative z-20 flex flex-col items-center w-full px-4 pt-20 pb-10 gap-4 sm:gap-8 sm:px-10 sm:pt-40 sm:pb-14 translate-y-2 sm:translate-y-0">
        ...
        <motion.div
           ...
           className="px-3 py-1 border border-gold/30 rounded-full bg-midnight/50 backdrop-blur-sm sm:px-4"
        >
          <span className="text-gold uppercase tracking-widest text-[10px] sm:text-xs font-semibold shadow-gold">VINIT CARS Collection</span>
        </motion.div>
        ...
        <motion.p
           ...
           className="text-gray-200 text-sm sm:text-xl max-w-[280px] sm:max-w-2xl text-center font-light tracking-wide shadow-black drop-shadow-lg"
        >
        ...
        <motion.div
          ...
          className="w-full flex justify-center mt-4 sm:mt-8 z-30"
        >
          {/* Glassmorphic border container */}
          <div className="p-[1px] rounded-[12px] sm:rounded-[16px] bg-gradient-to-r from-gold/40 via-gold/10 to-gold/40 backdrop-blur-xl shadow-[0_0_40px_rgba(212,175,55,0.2)] w-full max-w-[340px] sm:max-w-none">
            <div className="bg-midnight/60 rounded-[11px] sm:rounded-[15px] overflow-hidden backdrop-blur-3xl">
               <Search />
            </div>
          </div>
        </motion.div>
