...
const OwnersDetail = ({ carDetail }) => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="p-8 border border-white/10 rounded-[2.5rem] shadow-2xl mt-7 bg-[#111111] dark:bg-card relative overflow-hidden will-change-transform"
    >
      ...
      <div className="mt-10 flex flex-col gap-4">
        {/* 📞 Call Button */}
        <Button
          className="w-full bg-white dark:bg-gold text-black hover:bg-gold/90 font-black uppercase tracking-tighter flex items-center justify-center gap-3 py-7 rounded-2xl transition-all duration-300 shadow-lg shadow-gold/20 active:scale-95"
